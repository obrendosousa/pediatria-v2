...
// ─────────────────────────────────────────────────────────────────────────────
// ESTADO DO RESEARCHER — completamente isolado do estado principal do Clínica Geral
// ─────────────────────────────────────────────────────────────────────────────
...
• chat_messages: id, chat_id, sender, message_text, created_at
  ...
  → 'HUMAN_AGENT' = secretária/atendente humano ← use para analisar SCRIPT de atendimento
  → 'CUSTOMER' = paciente/lead ← use para analisar dúvidas, objeções, linguagem dos pacientes
  → 'AI_AGENT' = bot/agente IA ← use para analisar respostas automáticas
