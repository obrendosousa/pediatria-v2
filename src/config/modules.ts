...
export const PEDIATRIA_CONFIG: ModuleConfig = {
  ...
  theme: {
    ...
    activeGradient: 'bg-gradient-to-r from-rose-400 to-pink-300 dark:from-rose-400 dark:to-pink-400',
    border: 'border-rose-100 dark:border-[#2d2536]',
    borderAccent: 'border-rose-200 dark:border-rose-800/30',
    bgSubtle: 'bg-rose-50 dark:bg-rose-950/25',
    bgBlur: 'bg-rose-200 dark:bg-rose-400',
    hoverBg: 'hover:bg-rose-50 dark:hover:bg-white/[0.06]',
    text: 'text-rose-400 dark:text-rose-300',
    textBold: 'text-rose-500 dark:text-rose-300',
    shadow: 'shadow-[4px_0_24px_rgba(251,113,133,0.08)]',
    shadowActive: 'shadow-md shadow-rose-200 dark:shadow-lg dark:shadow-rose-400/10',
    selectionBg: 'selection:bg-rose-200 selection:text-rose-900',
    sparkleColor: 'text-rose-300 dark:text-rose-700',
  },
  routes: {
    chat: '/',
    crm: '/crm',
