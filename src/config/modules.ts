...
export interface ModuleTheme {
  ...
  border: string;            // ex: 'border-pink-100 dark:border-gray-800'
  borderAccent: string;      // ex: 'border-pink-200 dark:border-gray-700'
...
export const PEDIATRIA_CONFIG: ModuleConfig = {
  ...
  theme: {
    ...
    activeGradient: 'bg-gradient-to-r from-pink-500 to-rose-400',
    border: 'border-pink-100 dark:border-gray-800',
    borderAccent: 'border-pink-200 dark:border-gray-700',
    bgSubtle: 'bg-pink-50 dark:bg-pink-900/20',
    bgBlur: 'bg-pink-100 dark:bg-pink-500',
    hoverBg: 'hover:bg-pink-50 dark:hover:bg-white/5',
    ...
    shadowActive: 'shadow-md shadow-pink-200 dark:shadow-none',
...
export const ATENDIMENTO_CONFIG: ModuleConfig = {
  ...
  theme: {
    ...
    activeGradient: 'bg-gradient-to-r from-blue-500 to-sky-400',
    border: 'border-blue-100 dark:border-gray-800',
    borderAccent: 'border-blue-200 dark:border-gray-700',
    bgSubtle: 'bg-blue-50 dark:bg-blue-900/20',
    bgBlur: 'bg-blue-100 dark:bg-blue-500',
    hoverBg: 'hover:bg-blue-50 dark:hover:bg-white/5',
    text: 'text-blue-400 dark:text-blue-300',
    textBold: 'text-blue-600 dark:text-blue-400',
    shadow: 'shadow-[4px_0_24px_rgba(96,165,250,0.1)]',
    shadowActive: 'shadow-md shadow-blue-200 dark:shadow-none',
    selectionBg: 'selection:bg-blue-200 selection:text-blue-900',
    sparkleColor: 'text-blue-300 dark:text-blue-700',
  },
  routes: {
    chat: '/atendimento',
    crm: '/atendimento/crm',
