...
import { type FamilyMember, syncFlatColumnsFromFamilyMembers } from '@/constants/guardianRelationships';
...
export default function PatientModal({ isOpen, onClose, chatId, onSuccess }: PatientModalProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (flatCols.mother_name) payload.mother_name = flatCols.mother_name;
      if (flatCols.father_name) payload.father_name = flatCols.father_name;
