        ...
        {isViewingArchived ? (
          ...
          <div className="h-[60px] bg-primary/15 dark:bg-primary/20 flex items-center justify-between px-4 shrink-0 border-b border-primary/20 animate-in fade-in slide-in-from-top-2">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-primary-foreground/90 dark:text-[#fafafa] text-sm">
          ...
          <>
            <div className="h-[60px] bg-[#f0f2f5] dark:bg-[#18181b] flex items-center justify-between px-4 shrink-0 border-b border-gray-200/60 dark:border-[#2e2e33]">
              ...
              <div className="flex gap-1 text-[#54656f] dark:text-[#d4d4d8]">
                <button
                ...
                <div className="relative" ref={headerMenuRef}>
                  ...
                  {isHeaderMenuOpen && (
                    <div className="absolute right-0 top-12 w-56 bg-white dark:bg-[#18181b] rounded-xl shadow-[0_4px_24px_rgba(0,0,0,0.12)] py-1.5 z-[60] border border-gray-100 dark:border-[#2e2e33] animate-in fade-in zoom-in-95 duration-200 origin-top-right transition-all">
                      ...
                      >
                        <Tag size={16} className="text-[#54656f] dark:text-[#a1a1aa]" /> Gerenciar Etiquetas
                      </button>
                      <button className="w-full text-left px-4 py-2.5 hover:bg-gray-50 dark:hover:bg-white/5 flex items-center gap-3 text-[14px] text-[#3b4a54] dark:text-gray-200 cursor-pointer transition-colors">
                        <Settings size={16} className="text-[#54656f] dark:text-[#a1a1aa]" /> Configurações
                      </button>
                    </div>
                  )}
                </div>
            ...
            <div className="px-3 py-2 border-b border-gray-100 dark:border-[#27272a] bg-white dark:bg-[#0a0a0c] relative transition-colors duration-300">
              <div className="bg-[#f0f2f5] dark:bg-[#18181b] rounded-lg flex items-center px-3.5 py-1.5 h-[36px] transition-colors duration-300 focus-within:ring-2 focus-within:ring-green-300/50 dark:focus-within:ring-green-700/50">
                ...
                />
                {searchTerm && (
                  <button onClick={() => setSearchTerm('')} className="text-[#54656f] dark:text-[#a1a1aa] hover:text-[#3b4a54] dark:hover:text-gray-200 p-0.5 cursor-pointer transition-colors">
                    <X size={14} />
                  </button>
                )}
              </div>
              <button className="absolute right-5 top-1/2 -translate-y-1/2 text-[#54656f] dark:text-[#a1a1aa] hover:text-[#3b4a54] dark:hover:text-gray-200 cursor-pointer transition-colors" aria-label="Filtrar">
                <Filter size={16} />
              </button>
            </div>
          </>
