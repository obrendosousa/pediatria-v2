...
export default function ReceptionAppointmentModal({
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-[100] flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-white dark:bg-[#202c33] w-full max-w-lg rounded-2xl shadow-lg border border-slate-200 dark:border-[#252a3a] overflow-hidden animate-scale-in">
        {/* Header */}
        <div className="p-4 border-b border-slate-200 dark:border-[#252a3a] flex justify-between items-center bg-rose-50/50 dark:bg-rose-900/10">
          ...
          <button type="button" onClick={onClose} className="p-1.5 hover:bg-white/60 dark:hover:bg-white/10 rounded-lg transition-colors">
            <X size={18} className="text-slate-400 dark:text-[#565d73]" />
          </button>
        </div>
        ...
        <div className="p-5 space-y-4 max-h-[70vh] overflow-y-auto custom-scrollbar">
          ...
          {remainingDisplay > 0 && totalDisplay > 0 && !isEditing && (
            <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-4 space-y-3">
              ...
              <div className="grid grid-cols-3 gap-2 items-end text-center">
                <div>
                  <label className="text-[10px] text-slate-500 dark:text-[#828ca5] uppercase block mb-1">Total</label>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="0,00"
                    className="w-full text-sm font-bold border border-emerald-200 dark:border-emerald-700 rounded-lg px-2 py-2 bg-white dark:bg-[#141722] text-emerald-700 dark:text-emerald-300 focus:outline-none focus:ring-2 focus:ring-emerald-400"
                  />
                </div>
                <div>
                  <label className="text-[10px] text-slate-500 dark:text-[#828ca5] uppercase block mb-1">Falta</label>
              ...
              <div className="space-y-2">
                <p className="text-[10px] uppercase font-semibold text-slate-500 dark:text-[#828ca5]">Forma de pagamento</p>
                    ...
                    <button
                      ...
                      className={`rounded-lg border px-2 py-1.5 text-[11px] font-semibold transition-colors ${
                        paymentMode === method.key
                          ...
                          : 'border-slate-200 text-slate-600 hover:bg-slate-100 dark:border-[#252a3a] dark:text-[#a0a8be] dark:hover:bg-white/5'
                      }`}
                    >
                      {method.label}
                    </button>
                ...
                {paymentMode === 'mixed' && (
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <label className="text-[10px] uppercase text-slate-500 dark:text-[#828ca5]">Pix</label>
                      <input type="text" value={mixedPayments.pix} onChange={(e) => setMixedPayments((prev) => ({ ...prev, pix: formatMoneyInput(e.target.value) }))} placeholder="0,00" className="w-full rounded-lg border border-slate-200 dark:border-[#252a3a] px-2 py-1.5 text-xs bg-white dark:bg-[#141722] text-slate-700 dark:text-gray-200" />
                    </div>
                    <div>
                      <label className="text-[10px] uppercase text-slate-500 dark:text-[#828ca5]">Dinheiro</label>
                      <input type="text" value={mixedPayments.cash} onChange={(e) => setMixedPayments((prev) => ({ ...prev, cash: formatMoneyInput(e.target.value) }))} placeholder="0,00" className="w-full rounded-lg border border-slate-200 dark:border-[#252a3a] px-2 py-1.5 text-xs bg-white dark:bg-[#141722] text-slate-700 dark:text-gray-200" />
                    </div>
                    <div>
                      <label className="text-[10px] uppercase text-slate-500 dark:text-[#828ca5]">Crédito</label>
                      <input type="text" value={mixedPayments.credit_card} onChange={(e) => setMixedPayments((prev) => ({ ...prev, credit_card: formatMoneyInput(e.target.value) }))} placeholder="0,00" className="w-full rounded-lg border border-slate-200 dark:border-[#252a3a] px-2 py-1.5 text-xs bg-white dark:bg-[#141722] text-slate-700 dark:text-gray-200" />
                    </div>
                    <div>
                      <label className="text-[10px] uppercase text-slate-500 dark:text-[#828ca5]">Débito</label>
                      <input type="text" value={mixedPayments.debit_card} onChange={(e) => setMixedPayments((prev) => ({ ...prev, debit_card: formatMoneyInput(e.target.value) }))} placeholder="0,00" className="w-full rounded-lg border border-slate-200 dark:border-[#252a3a] px-2 py-1.5 text-xs bg-white dark:bg-[#141722] text-slate-700 dark:text-gray-200" />
                    </div>
                  </div>
                )}
              </div>
          ...
          {/* Paciente */}
          <div className="flex items-center gap-3 pb-4 border-b border-slate-200 dark:border-[#252a3a]">
            ...
            <div className="flex-1">
              {isEditing ? (
                <div className="space-y-1">
                  <label className="text-[10px] font-semibold text-slate-500 dark:text-[#828ca5] uppercase">Nome do paciente</label>
                  <input
                    type="text"
                    className="w-full text-sm font-medium text-slate-800 dark:text-[#e8ecf4] border border-slate-200 dark:border-gray-600 rounded-lg px-3 py-1.5 focus:border-rose-400 focus:ring-1 focus:ring-rose-400/20 outline-none bg-white dark:bg-[#141722]"
                ...
                <h4 className="text-base font-semibold text-slate-800 dark:text-[#e8ecf4]">
          ...
          {/* Data de Nascimento */}
          {isEditing ? (
            <div className="flex items-center gap-2.5 p-2.5 bg-slate-50 dark:bg-[#1a1f28] rounded-lg border border-slate-200 dark:border-[#252a3a]">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-semibold text-slate-500 dark:text-[#828ca5] uppercase">Data de Nascimento *</p>
                <input
                  type="text"
                  ...
                  maxLength={10}
                  className="w-full text-sm font-medium text-slate-700 dark:text-gray-200 border border-slate-200 dark:border-gray-600 rounded-md px-2 py-1.5 focus:border-rose-400 focus:ring-1 focus:ring-rose-400/20 outline-none bg-white dark:bg-[#141722]"
                />
              </div>
            </div>
          ) : (
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 bg-slate-50 dark:bg-[#1a1f28] rounded-lg border border-slate-200 dark:border-[#252a3a]">
              <div className="flex items-center gap-1.5 mb-1.5">
                <CalendarDays size={14} className="text-rose-500 dark:text-rose-400" />
                <span className="text-[10px] font-semibold text-slate-500 dark:text-[#828ca5] uppercase">Data</span>
              </div>
              {isEditing ? (
                <input
                  type="text"
                  ...
                  placeholder="DD/MM/AAAA"
                  maxLength={10}
                  className="w-full text-sm font-semibold text-slate-700 dark:text-gray-200 border border-slate-200 dark:border-gray-600 rounded-md px-2 py-1.5 focus:border-rose-400 focus:ring-1 focus:ring-rose-400/20 outline-none bg-white dark:bg-[#141722]"
                />
              ) : (
            ...
            <div className="p-3 bg-slate-50 dark:bg-[#1a1f28] rounded-lg border border-slate-200 dark:border-[#252a3a]">
              <div className="flex items-center gap-1.5 mb-1.5">
                ...
                <span className="text-[10px] font-semibold text-slate-500 dark:text-[#828ca5] uppercase">Horário</span>
              </div>
              {isEditing ? (
                <input
                  type="time"
          ...
          <div className="flex items-center gap-2.5 p-2.5 bg-slate-50 dark:bg-[#1a1f28] rounded-lg border border-slate-200 dark:border-[#252a3a]">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[10px] font-semibold text-slate-500 dark:text-[#828ca5] uppercase">Médico</p>
              {isEditing ? (
                <select
                  value={form.doctor_id ?? ''}
                  onChange={e => setForm(prev => ({ ...prev, doctor_id: e.target.value ? Number(e.target.value) : null }))}
                  className="w-full text-sm text-slate-700 dark:text-gray-200 font-medium border border-slate-200 dark:border-gray-600 rounded-md px-2 py-1.5 focus:border-rose-400 focus:ring-1 focus:ring-rose-400/20 outline-none bg-white dark:bg-[#141722]"
                >
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2.5 p-2.5 bg-slate-50 dark:bg-[#1a1f28] rounded-lg border border-slate-200 dark:border-[#252a3a]">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-semibold text-slate-500 dark:text-[#828ca5] uppercase">Responsável</p>
                {isEditing ? (
                  <input
                    type="text"
            ...
            <div className="flex items-center gap-2.5 p-2.5 bg-slate-50 dark:bg-[#1a1f28] rounded-lg border border-slate-200 dark:border-[#252a3a]">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-semibold text-slate-500 dark:text-[#828ca5] uppercase">WhatsApp</p>
                {isEditing ? (
                  <input
                    type="text"
          ...
          <div className="bg-amber-50 dark:bg-amber-900/10 p-3 rounded-xl border border-amber-200 dark:border-amber-800/50">
            ...
            {isEditing ? (
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-[10px] text-slate-500 dark:text-[#828ca5] uppercase">Total (R$)</label>
                  <input type="text" value={form.totalAmount} onChange={e => handleMoneyInput('totalAmount', e.target.value)} className="w-full text-sm font-bold border border-slate-200 dark:border-gray-600 rounded px-2 py-1.5 bg-white dark:bg-[#141722] text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-1 focus:ring-amber-400" placeholder="0,00" />
                </div>
                <div>
                ...
                <div className="col-span-2 text-right text-xs font-bold text-slate-600 dark:text-[#a0a8be] border-t border-amber-200 dark:border-amber-800 pt-2 mt-1">
              ...
              <div className="flex justify-between items-center bg-white dark:bg-black/20 p-2.5 rounded-lg border border-amber-200/50 dark:border-amber-800/30">
                <div>
                  <p className="text-[10px] text-slate-500 dark:text-[#828ca5] uppercase font-semibold">Total</p>
                ...
                <div className="text-right">
                  <p className="text-[10px] text-slate-500 dark:text-[#828ca5] uppercase font-semibold">Falta</p>
                  <p className={`text-sm font-black ${remainingDisplay > 0 ? 'text-rose-500 dark:text-rose-400' : 'text-slate-400 dark:text-[#565d73]'}`}>
          ...
          <div className="p-3 bg-slate-50 dark:bg-[#1a1f28] rounded-lg border border-slate-200 dark:border-[#252a3a]">
            <div className="flex items-center gap-2 mb-2">
              <FileText size={14} className="text-slate-500 dark:text-[#828ca5]" />
              <p className="text-[10px] font-semibold text-slate-500 dark:text-[#828ca5] uppercase">Observações</p>
            </div>
            {isEditing ? (
              <textarea
                className="w-full p-2.5 text-sm text-slate-700 dark:text-gray-200 border border-slate-200 dark:border-gray-600 rounded-lg focus:border-rose-400 focus:ring-1 focus:ring-rose-400/20 outline-none bg-white dark:bg-[#141722] min-h-[60px] resize-y"
                value={form.notes}
                onChange={e => setForm(prev => ({ ...prev, notes: e.target.value }))}
                placeholder="Anotações..."
              />
            ) : (
              <p className="text-xs text-slate-600 dark:text-[#a0a8be] leading-relaxed">
        ...
        {/* Rodapé */}
        <div className="p-4 bg-slate-50/50 dark:bg-[#0d0f15] border-t border-slate-200 dark:border-[#252a3a] flex gap-2">
          {isEditing ? (
            <>
              <button
                type="button"
                onClick={() => setIsEditing(false)}
                className="flex-1 bg-white dark:bg-[#141722] border border-slate-300 dark:border-gray-600 text-slate-600 dark:text-[#a0a8be] py-2 rounded-lg text-xs font-semibold hover:bg-slate-50 dark:hover:bg-white/10 transition-colors"
              >
                Cancelar
              </button>
              <button
