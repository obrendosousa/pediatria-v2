...
export default function ClaraSuggestionPanel({
  ...
  return (
    <div className="absolute right-[52px] sm:right-[58px] top-[56px] bottom-[68px] z-[45] w-[360px] max-w-[calc(100vw-120px)]
      flex flex-col bg-white dark:bg-[#1a2328] border-l border-gray-200 dark:border-gray-700
      shadow-2xl animate-in slide-in-from-right-4 fade-in duration-250">

      {/* Header */}
      <div className="flex items-center gap-2.5 px-4 py-3 border-b border-gray-100 dark:border-gray-700/80 shrink-0">
      ...
      {hasBoth && (
        <div className="flex border-b border-gray-100 dark:border-gray-700/80 shrink-0">
          <button
