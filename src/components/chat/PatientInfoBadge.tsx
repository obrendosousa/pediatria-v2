      ...
      {isOpen && mounted && typeof document !== 'undefined' && createPortal(
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-[#2d2d36] bg-slate-50/50 dark:bg-[#181a20]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-[#a1a1aa]">Informações do Paciente</p>
                </div>
              </div>
              <button
                onClick={() => setIsOpen(false)}
              ...
              {loading ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="text-xs font-bold text-slate-500 dark:text-[#a1a1aa] uppercase">Nome</label>
                      <p className="text-sm font-semibold text-slate-800 dark:text-[#fafafa] mt-1">
                        {patient.name}
                      </p>
                    </div>
                    {patient.birth_date && (
                      <div>
                        <label className="text-xs font-bold text-slate-500 dark:text-[#a1a1aa] uppercase">Data de Nascimento</label>
                        <p className="text-sm font-semibold text-slate-800 dark:text-[#fafafa] mt-1">
                    ...
                    {patient.phone && (
                      <div>
                        <label className="text-xs font-bold text-slate-500 dark:text-[#a1a1aa] uppercase">Telefone Principal</label>
                        <p className="text-sm font-semibold text-slate-800 dark:text-[#fafafa] mt-1">
                          {patient.phone}
                        </p>
                      </div>
                  ...
                  {phones.length > 0 && (
                    <div>
                      <label className="text-xs font-bold text-slate-500 dark:text-[#a1a1aa] uppercase mb-2 block">
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="font-medium text-slate-800 dark:text-[#fafafa]">
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <p className="text-sm font-semibold text-slate-800 dark:text-[#fafafa]">
            ...
            {/* Footer */}
            <div className="px-6 py-4 border-t border-slate-200 dark:border-[#2d2d36] bg-slate-50/50 dark:bg-[#181a20] flex justify-end gap-3">
              <button
                onClick={() => setIsOpen(false)}
                className="px-4 py-2 text-slate-600 dark:text-[#d4d4d8] font-semibold text-sm hover:bg-slate-100 dark:hover:bg-white/5 rounded-xl transition-colors"
              >
                Fechar
              </button>
              <button
