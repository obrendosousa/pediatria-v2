      ...
      <div className="bg-white dark:bg-[#233138] rounded-xl shadow-2xl w-full max-w-md max-h-[85vh] flex flex-col border border-gray-200 dark:border-[#3d3d48]">
        <div className="p-4 border-b border-gray-100 dark:border-[#3d3d48] flex items-center justify-between shrink-0">
          ...
          <button
            type="button"
            onClick={onClose}
            className="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 text-gray-500 dark:text-[#a1a1aa]"
            aria-label="Fechar"
          >
            <X size={20} />
          </button>
        ...
        <div className="p-2 border-b border-gray-100 dark:border-[#3d3d48] shrink-0">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-[#0b141a] text-gray-900 dark:text-[#fafafa] placeholder-gray-400 text-sm focus:ring-2 focus:ring-green-500/30 focus:border-green-500 outline-none"
            />
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 overflow-y-auto">
          {isLoading ? (
            ...
            <div className="py-12 text-center text-sm text-gray-500 dark:text-[#a1a1aa]">
                ...
                <li key={c.id}>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-gray-500 dark:text-[#a1a1aa] truncate">
        ...
        <div className="p-4 border-t border-gray-100 dark:border-[#3d3d48] flex gap-2 shrink-0">
          <button
            type="button"
            onClick={onClose}
            className="flex-1 py-2.5 rounded-lg border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-[#d4d4d8] hover:bg-gray-50 dark:hover:bg-white/5 text-sm font-medium transition-colors"
          >
            Cancelar
          </button>
          <button
