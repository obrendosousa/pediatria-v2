...
export default function AudioMessage({ 
  ...
  return (
    <div className={`flex items-center gap-3 py-2 select-none w-[280px] min-w-[240px] max-w-full ${simpleMode ? 'pr-1' : ''}`} style={{ flexShrink: 0 }}>
      ...
      {/* Botão de Play */}
      <button onClick={togglePlay} className="shrink-0 w-10 h-10 flex items-center justify-center rounded-full bg-black/5 hover:bg-black/10 transition-colors text-gray-600 dark:text-[#d4d4d8]" disabled={isLoading}>
      ...
      <div className="flex-1 flex flex-col justify-center min-w-[140px] h-[52px] shrink-0">
          ...
          <div className="flex justify-between items-center text-[11px] text-gray-500 dark:text-[#a1a1aa] font-medium px-0.5 pt-1">
