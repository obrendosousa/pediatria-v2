    ...
    <div className="bg-white dark:bg-[#0a0a0c] rounded-2xl border border-slate-200/60 dark:border-[#27272a]/60 p-5 sm:p-6 shadow-sm hover:shadow-lg transition-all duration-300 animate-in fade-in slide-in-from-bottom-4">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-black text-slate-900 dark:text-[#fafafa]">IA Pulse</h3>
            <p className="text-xs text-slate-500 dark:text-[#a1a1aa]">Análise inteligente em tempo real</p>
          </div>
        </div>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="font-bold text-slate-800 dark:text-[#fafafa] mb-1">{insight.title}</h4>
                <p className="text-sm text-slate-600 dark:text-[#a1a1aa] leading-relaxed">{insight.message}</p>
                {insight.action && (
                  <button
