...
export default function ReceptionColumn({
  ...
  return (
    <div className={`flex flex-col overflow-hidden transition-colors bg-white dark:bg-[#0e0e12] rounded-xl border border-slate-200 dark:border-[#2d2d36] shadow-sm ${isSelectMode ? 'min-w-0' : 'flex-1 min-w-[240px]'}`}>
      {/* Header compacto */}
