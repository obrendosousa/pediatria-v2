...
export default function ReceptionColumn({
  ...
  return (
    <div className={`flex flex-col overflow-hidden transition-colors bg-white dark:bg-[#0a0a0c] rounded-xl border border-slate-200 dark:border-[#27272a] shadow-sm ${isSelectMode ? 'min-w-0' : 'flex-1 min-w-[240px]'}`}>
      {/* Header compacto */}
