          ...
          {daysInMonth.map((d, i) => {
            ...
            return (
              <button
                ...
                className={`h-8 w-8 rounded-lg text-xs font-bold transition-all flex items-center justify-center ${isSelected ? 'bg-teal-500 text-white shadow-md' : 'text-slate-600 dark:text-gray-400 hover:bg-slate-50 dark:hover:bg-white/10'}`}
              >
                {d.getDate()}
              </button>
            );
