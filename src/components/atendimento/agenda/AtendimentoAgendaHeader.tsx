  ...
  return (
    <div className="h-16 px-6 flex items-center justify-between bg-white dark:bg-[#0d0f15] border-b border-slate-100 dark:border-[#1e2334] shadow-sm z-20 transition-colors">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-base font-bold text-slate-800 dark:text-[#e8ecf4] leading-none">Agenda</h1>
      ...
      <select
        ...
        className="text-xs font-medium border border-slate-200 dark:border-[#252a3a] rounded-lg px-3 py-1.5 bg-white dark:bg-[#141722] text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-1 focus:ring-teal-400"
      >
      ...
      <div className="flex items-center gap-3">
        ...
        <Link href="/atendimento/agenda/gerenciar" className="flex items-center gap-2 bg-slate-100 dark:bg-[#141722] hover:bg-slate-200 dark:hover:bg-white/10 text-slate-700 dark:text-gray-200 px-3 py-2 rounded-lg text-xs font-bold transition-colors"><ClipboardList className="w-3.5 h-3.5" /> Gerenciar</Link>
        <Link href="/atendimento/agenda/bloqueios" className="flex items-center gap-2 bg-slate-100 dark:bg-[#141722] hover:bg-slate-200 dark:hover:bg-white/10 text-slate-700 dark:text-gray-200 px-3 py-2 rounded-lg text-xs font-bold transition-colors"><Ban className="w-3.5 h-3.5" /> Bloqueios</Link>
