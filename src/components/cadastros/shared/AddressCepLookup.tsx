...
export default function AddressCepLookup({ value, onChange, disabled = false }: AddressCepLookupProps) {
  ...
  const inputClass = 'w-full px-3 py-2 text-sm border border-slate-200 dark:border-gray-700 rounded-lg bg-white dark:bg-[#2a2d36] text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-400 disabled:opacity-50 disabled:cursor-not-allowed';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        {/* Cidade */}
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">Cidade</label>
          <input
            type="text"
            value={value.city}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="sm:col-span-2">
          <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">Logradouro</label>
          <input
            type="text"
            value={value.street}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {/* Bairro */}
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">Bairro</label>
          <input
            type="text"
        ...
        {/* Número */}
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">Número</label>
          <input
            type="text"
            value={value.number}
        ...
        {/* Complemento */}
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">Complemento</label>
          <input
            type="text"
