            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-lg text-sm bg-white dark:bg-[#18181b] text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-400 ${
                    nameError ? 'border-red-400 dark:border-red-500' : 'border-slate-200 dark:border-[#2e2e33]'
                  }`}
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2 border border-slate-200 dark:border-[#2e2e33] rounded-lg text-sm bg-white dark:bg-[#18181b] text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-400 resize-none"
                />
              </div>
              ...
              <div className="flex flex-col gap-2">
                {items.map((item, idx) => (
                  <div
                    ...
                    className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-[#18181b] rounded-lg border border-slate-100 dark:border-[#27272a] group"
                  >
                ...
                {/* Total */}
                <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-200 dark:border-[#2e2e33] mt-1">
