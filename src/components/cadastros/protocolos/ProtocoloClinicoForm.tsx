            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-lg text-sm bg-white dark:bg-[#141722] text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-400 ${
                    nameError ? 'border-red-400 dark:border-red-500' : 'border-slate-200 dark:border-[#252a3a]'
                  }`}
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2 border border-slate-200 dark:border-[#252a3a] rounded-lg text-sm bg-white dark:bg-[#141722] text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-400 resize-none"
                />
              </div>
              ...
              <div className="flex flex-col gap-2">
                {items.map((item, idx) => (
                  <div
                    ...
                    className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-[#141722] rounded-lg border border-slate-100 dark:border-[#1e2334] group"
                  >
                    <span className="text-xs text-slate-400 dark:text-[#565d73] font-mono w-5 text-right shrink-0">
                      {idx + 1}.
                    </span>
                    ...
                    <span className="text-xs font-mono text-slate-500 dark:text-[#828ca5] shrink-0">
                ...
                {/* Total */}
                <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-200 dark:border-[#252a3a] mt-1">
                  <DollarSign className="w-4 h-4 text-teal-600" />
                  <span className="text-sm text-slate-500 dark:text-[#828ca5]">Valor total:</span>
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        <p className={`text-sm truncate transition-colors ${
                          isAdded
                            ? 'text-slate-400 dark:text-[#565d73]'
                            : 'text-slate-700 dark:text-gray-200 group-hover:text-teal-700 dark:group-hover:text-teal-300'
                        }`}>
                          {proc.name}
                        </p>
                        <p className="text-xs text-slate-400 dark:text-[#565d73] font-mono">
