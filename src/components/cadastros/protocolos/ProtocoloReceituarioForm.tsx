...
export default function ProtocoloReceituarioForm({
  ...
  const [showSupportHealth, setShowSupportHealth] = useState(false);
    ...
    <div className="h-full flex flex-col bg-slate-50 dark:bg-[#15171e]">
      ...
      >
        ...
        <div className="flex-1 flex flex-col overflow-y-auto p-6 gap-5">
          ...
          {/* Editor de conteúdo */}
          <div className="bg-white dark:bg-[#1e2028] rounded-xl border border-slate-200 dark:border-gray-700 p-5 flex flex-col gap-3">
