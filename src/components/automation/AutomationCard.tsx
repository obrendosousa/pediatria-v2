...
export default function AutomationCard({
  ...
  return (
    <div className={`group relative bg-white dark:bg-[#08080b] border border-slate-200/60 dark:border-[#3d3d48]/60 rounded-3xl p-6 hover:shadow-xl hover:shadow-slate-200/50 dark:hover:shadow-black/50 hover:-translate-y-1 transition-all duration-300 overflow-hidden`}>
      ...
      <div className="flex items-start justify-between mb-6 z-10 relative">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-3">
            <div className={`w-10 h-10 rounded-2xl flex items-center justify-center bg-white dark:bg-[#252833] shadow-sm border border-slate-100 dark:border-[#2d2d36] ${getIconColor()}`}>
      ...
      <div className="flex flex-col gap-2 mb-6">
        <div className="flex items-center gap-2.5 px-3 py-2.5 bg-slate-50 dark:bg-[#252833] rounded-xl border border-slate-100 dark:border-[#2d2d36]/50">
      ...
      {stats && (
        <div className="grid grid-cols-2 gap-3 mb-6 p-4 bg-slate-50 dark:bg-[#252833] rounded-2xl border border-slate-100 dark:border-[#2d2d36]/50">
          <div>
      ...
      <div className="flex items-center gap-2">
        <button
          onClick={onEdit}
          className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-white dark:bg-[#08080b] border border-slate-200 dark:border-[#3d3d48] hover:border-slate-300 dark:hover:border-gray-600 hover:bg-slate-50 dark:hover:bg-white/5 rounded-xl text-sm font-bold text-slate-700 dark:text-[#d4d4d8] transition-colors"
        >
        ...
        <button
          onClick={onDelete}
          className="flex items-center justify-center p-2.5 bg-white dark:bg-[#08080b] border border-slate-200 dark:border-[#3d3d48] hover:bg-red-50 hover:border-red-200 hover:text-red-500 dark:hover:bg-red-900/20 dark:hover:border-red-800/30 dark:hover:text-red-400 rounded-xl text-slate-400 transition-colors"
          title="Excluir"
        >
