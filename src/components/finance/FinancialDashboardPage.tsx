    ...
    <div className="h-full flex flex-col bg-[#f8fafc] dark:bg-[#0b141a] relative overflow-hidden transition-colors duration-300">
      ...
      <div className="h-16 px-6 flex items-center justify-between bg-white dark:bg-[#0a0a0c] border-b border-slate-100 dark:border-[#27272a] shadow-sm z-20 transition-colors">
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-lg border border-slate-200 dark:border-[#2e2e33] text-xs font-bold text-slate-700 dark:text-gray-200 hover:bg-slate-50 dark:hover:bg-white/5 flex items-center gap-1.5"
        >
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-8 z-10">
        <div className="flex items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-2 bg-white dark:bg-[#0a0a0c] rounded-xl border border-slate-100 dark:border-[#27272a] p-1">
            {([
          ...
          <div className="flex items-center gap-2">
            {([
              ...
              <button
                ...
                className={`px-3 py-2 rounded-lg text-xs font-bold border ${preset === option.key ? 'bg-emerald-500 text-white border-emerald-500' : 'bg-white dark:bg-[#0a0a0c] text-slate-700 dark:text-gray-200 border-slate-200 dark:border-[#2e2e33]'}`}
              >
                {option.label}
              </button>
            ))}
        ...
        {preset === 'custom' && (
          <div className="mb-6 bg-white dark:bg-[#0a0a0c] rounded-xl border border-slate-100 dark:border-[#27272a] p-4 flex items-center gap-3">
            <CalendarRange className="w-4 h-4 text-slate-500" />
            <input
              type="date"
              value={customStart}
              onChange={(e) => setCustomStart(e.target.value)}
              className="px-3 py-2 rounded-lg border border-slate-200 dark:border-[#2e2e33] bg-white dark:bg-[#18181b] text-sm"
            />
        ...
        {activeTab === 'overview' && overview && (
          <>
            ...
            <div className="grid grid-cols-3 gap-6 mb-6">
              <div className="col-span-2 bg-white dark:bg-[#0a0a0c] rounded-2xl border border-slate-100 dark:border-[#27272a] p-4 h-[320px]">
              ...
              <div className="bg-white dark:bg-[#0a0a0c] rounded-2xl border border-slate-100 dark:border-[#27272a] p-4 h-[320px]">
            ...
            <div className="grid grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-white dark:bg-[#0a0a0c] rounded-2xl border border-slate-100 dark:border-[#27272a] p-4">
                ...
                <div className="space-y-2">
                  ...
                  {overview.bestClients.map((client, index) => (
                    <div key={`${client.name}-${index}`} className="flex items-center justify-between rounded-lg border border-slate-100 dark:border-[#2e2e33] px-3 py-2">
        ...
        {activeTab === 'closure' && closure && (
          <div className="space-y-4">
            ...
            <div className="bg-white dark:bg-[#0a0a0c] rounded-2xl border border-slate-100 dark:border-[#27272a] overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="bg-slate-50 dark:bg-[#18181b]">
                    <tr>
                  ...
                  <tbody>
                    ...
                    {closure.logs.map((log) => (
                      <tr key={log.id} className="border-t border-slate-100 dark:border-[#27272a]">
                        ...
                        {profile?.role === 'admin' && (
                          <td className="px-4 py-3 text-center">
                            <button
                              ...
                              className="inline-flex items-center gap-1 rounded-lg border border-slate-200 px-2 py-1 text-xs font-bold text-slate-600 hover:bg-slate-100 dark:border-[#2e2e33] dark:text-[#d4d4d8] dark:hover:bg-white/10"
                            >
      ...
      {editingLog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-xl rounded-2xl border border-slate-200 bg-white p-5 shadow-2xl dark:border-[#2e2e33] dark:bg-[#0a0a0c]">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm dark:border-[#2e2e33] dark:bg-[#18181b]"
                />
              </div>
              <div>
            ...
            <div className="mt-4 flex justify-end gap-2">
              <button
                ...
                className="rounded-lg border border-slate-200 px-3 py-2 text-xs font-bold text-slate-600 dark:border-[#2e2e33] dark:text-[#d4d4d8]"
              >
                Cancelar
              </button>
              <button
...
function SummaryValue({ label, value }: { label: string; value: number }) {
  return (
    <div className="rounded-xl border border-slate-100 dark:border-[#2e2e33] bg-slate-50 dark:bg-slate-800 p-3">
      <p className="text-[11px] uppercase font-bold text-slate-500 dark:text-[#a1a1aa]">{label}</p>
