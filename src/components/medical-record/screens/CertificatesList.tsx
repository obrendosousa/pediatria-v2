    ...
    return (
      <div className="p-6 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-bold text-slate-800 dark:text-[#fafafa]">{selected.title || 'Atestado'}</h2>
  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-bold text-slate-800 dark:text-[#fafafa]">Atestados</h2>
        <button
