...
export function ReportsList({ patientId, appointmentId }: AttendanceScreenProps) {
    ...
    return (
      <div className="p-6 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-bold text-slate-800 dark:text-gray-100">{selected.title || 'Laudo'}</h2>
  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-bold text-slate-800 dark:text-gray-100">Laudos</h2>
        <button
      ...
      {reports.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-sm text-slate-400 dark:text-gray-500">Nenhum laudo registrado.</p>
        </div>
      ) : (
