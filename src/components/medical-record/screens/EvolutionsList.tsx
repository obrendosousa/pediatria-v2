...
export function EvolutionsList({ patientId, appointmentId }: AttendanceScreenProps) {
    ...
    return (
      <div className="p-6 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-bold text-slate-800 dark:text-gray-100">Evolução Clínica</h2>
    ...
    return (
      <div className="p-6 space-y-4">
        ...
        <div className="flex items-center gap-6 flex-wrap">
          ...
          {showDate && (
            <div>
              <label className="text-xs font-bold text-slate-600 dark:text-gray-400 mb-1 block">Data da evolução</label>
              <input
                type="date"
                value={evolutionDate}
  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-bold text-slate-800 dark:text-gray-100">Evoluções Clínicas</h2>
        <button
      ...
      {evolutions.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-sm text-slate-400 dark:text-gray-500">Nenhuma evolução registrada.</p>
        </div>
      ) : (
          ...
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="bg-slate-50 dark:bg-[#2a2d36] border-b border-slate-200 dark:border-gray-700">
                ...
                <th className="px-4 py-3 text-xs font-extrabold text-slate-500 dark:text-gray-400 uppercase">Data da evolução</th>
    ...
    return (
      <div className="w-64 shrink-0 bg-slate-50 dark:bg-[#16171c] rounded-xl border border-slate-200 dark:border-gray-700 p-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-xs font-extrabold text-slate-500 dark:text-gray-400 uppercase">Modelos de evolução</h3>
        </div>
