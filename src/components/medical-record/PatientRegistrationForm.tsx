    ...
    <div className="bg-white dark:bg-[#08080b] rounded-xl border border-slate-200 dark:border-[#2d2d36] overflow-hidden">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-[#2d2d36] bg-slate-50/50 dark:bg-[#181a20]">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-[#a1a1aa] mt-0.5 ml-9">
        ...
        <aside className="w-56 bg-slate-50/50 dark:bg-[#181a20] border-r border-slate-200 dark:border-[#2d2d36] flex flex-col py-4 px-3 gap-2">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-[10px] text-slate-500 dark:text-[#71717a]">Identificação</div>
            </div>
          </button>
          <button
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-[10px] text-slate-500 dark:text-[#71717a]">Família</div>
            </div>
          </button>
          <button
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-[10px] text-slate-500 dark:text-[#71717a]">Planos</div>
            </div>
          </button>
        </aside>
                  ...
                  <div className="col-span-12 flex items-start gap-6 mb-4">
                    ...
                    <div className="flex-1 grid grid-cols-12 gap-4">
                      ...
                      <div className="col-span-12 md:col-span-7">
                        <label className="text-xs font-bold text-slate-500 dark:text-[#a1a1aa] mb-1.5 block ml-1 uppercase">Sexo Biológico *</label>
