...
export function PatientStickyHeader({ 
  ...
  return (
    <div className="sticky top-0 z-10 bg-white/80 dark:bg-[#0d0f15]/90 backdrop-blur-md border-b border-slate-200 dark:border-[#1e2334] shadow-sm transition-all">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-3 sm:gap-4 lg:gap-5 min-w-0 flex-1">
            ...
            {onBack && (
              <button
                onClick={onBack}
                className="flex-shrink-0 p-2 hover:bg-slate-100 dark:hover:bg-[#2a2d36] rounded-lg transition-colors text-slate-600 dark:text-[#828ca5] hover:text-slate-800 dark:hover:text-gray-200"
            ...
            <div className="min-w-0 flex-1">
               <h1 className="text-base sm:text-lg lg:text-xl font-black text-slate-800 dark:text-[#e8ecf4] flex items-center gap-2 sm:gap-3 min-w-0">
               ...
               <div className="flex flex-wrap items-center gap-2 sm:gap-3 lg:gap-4 mt-1 sm:mt-1.5 text-xs font-medium text-slate-500 dark:text-[#828ca5]">
                 {/* Idade Precisa */}
                 <span className="flex items-center gap-1.5 bg-slate-100 dark:bg-[#141722] px-2 py-1 rounded-md flex-shrink-0">
          ...
          <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 flex-shrink-0 w-full sm:w-auto justify-end sm:justify-start">
            ...
            {!isConsultationActive ? (
              ...
              <button 
                ...
                className="bg-slate-100 hover:bg-slate-200 dark:bg-[#141722] dark:hover:bg-[#353842] text-slate-700 dark:text-gray-200 px-3 sm:px-4 lg:px-6 py-2 sm:py-2.5 lg:py-3 rounded-lg sm:rounded-xl font-bold border border-slate-200 dark:border-[#252a3a] transition-all active:scale-95 flex items-center gap-1.5 sm:gap-2 text-sm sm:text-base"
              >
            ...
            {onEditPatient && (
              <button
                ...
                className="p-2 sm:p-2.5 lg:p-3 rounded-lg sm:rounded-xl hover:bg-slate-50 dark:hover:bg-[#2a2d36] text-slate-500 dark:text-[#828ca5] hover:text-rose-500 dark:hover:text-rose-400 border border-transparent hover:border-slate-200 dark:hover:border-gray-700 transition-all flex-shrink-0"
      ...
      {isConsultationActive && (
        <div className="h-0.5 w-full bg-slate-100 dark:bg-[#141722] overflow-hidden">
