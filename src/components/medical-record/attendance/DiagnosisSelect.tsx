          ...
          {isLoading ? (
            ...
            options.map((option, index) => (
              ...
              >
                ...
                <div className="text-sm text-slate-600 dark:text-[#a1a1aa] mt-0.5">
                  {option.description}
                </div>
              </button>
            ))
            ...
            <div className="p-4">
              <div className="text-center text-slate-600 dark:text-[#a1a1aa] mb-2">
                Nenhum resultado encontrado
              </div>
              <div className="text-xs text-slate-500 dark:text-[#71717a] text-center">
