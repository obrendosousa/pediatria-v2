    ...
    <div className="bg-white dark:bg-[#0a0a0c] rounded-lg border border-slate-200 dark:border-[#2e2e33] p-4 space-y-4">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          <span className="text-xs text-slate-600 dark:text-[#a1a1aa]">Incluir data</span>
        </label>

        {/* Data */}
        {draft.include_date && (
          <div className="flex items-center gap-1">
            <span className="text-xs text-slate-500 dark:text-[#a1a1aa] uppercase font-medium">DATA</span>
            <input
              type="date"
      ...
      {/* Indicação clínica */}
      <div>
        <label className="block text-xs font-medium text-slate-500 dark:text-[#a1a1aa] mb-1 uppercase">
      ...
      <div>
        <div className="flex justify-between items-center mb-2">
          <label className="text-xs font-medium text-slate-500 dark:text-[#a1a1aa] uppercase">Exames</label>
          <span className="text-xs text-slate-400 dark:text-[#71717a]">Quantidade</span>
        </div>
  ...
  return (
    <div className="p-4 pb-6">
      ...
      <div className="mb-4 flex justify-between items-center">
        <h1 className="text-xl font-bold text-slate-800 dark:text-[#fafafa]">Exames e Procedimentos</h1>
