    ...
    <div>
      ...
      <div className="flex gap-4">
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          <span className="text-sm text-slate-700 dark:text-[#d4d4d8]">Sim</span>
        </label>
        <label className="flex items-center gap-2 cursor-pointer">
          <input type="radio" {...register(name)} value="não" className="w-4 h-4 text-blue-600 focus:ring-blue-500" />
          <span className="text-sm text-slate-700 dark:text-[#d4d4d8]">Não</span>
        </label>
      </div>
    </div>
  );
      ...
      <div className="flex flex-wrap gap-4">
        {options.map((opt) => (
          <label key={opt.value} className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-sm text-slate-700 dark:text-[#d4d4d8]">{opt.label}</span>
          </label>
        ))}
      </div>
    </div>
  ...
  return (
    <div className="p-4 pb-20">
      ...
      <div className="mb-4 flex justify-between items-center">
        <h1 className="text-xl font-bold text-slate-800 dark:text-[#fafafa]">ANAMNESE DA 1ª CONSULTA</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
        ...
        <div className={sectionClass}>
          <h2 className="text-sm font-semibold text-slate-800 dark:text-[#fafafa] mb-3">Informações Pessoais</h2>
        ...
        {/* ─── Seção 2: Antecedentes ─── */}
        <div className={sectionClass}>
          <h2 className="text-sm font-semibold text-slate-800 dark:text-[#fafafa] mb-3">Antecedentes</h2>
        ...
        <div className={sectionClass}>
          <h2 className="text-sm font-semibold text-slate-800 dark:text-[#fafafa] mb-3">Informações da Mãe e Alimentação</h2>
        ...
        {/* ─── Seção 4: Adaptação e Sintomas do RN ─── */}
        <div className={sectionClass}>
          <h2 className="text-sm font-semibold text-slate-800 dark:text-[#fafafa] mb-3">Adaptação e Sintomas do RN</h2>
        ...
        {/* ─── Seção 5: Higiene e Cuidados ─── */}
        <div className={sectionClass}>
          <h2 className="text-sm font-semibold text-slate-800 dark:text-[#fafafa] mb-3">Higiene e Cuidados</h2>
        ...
        {/* ─── Seção 6: Sono e Desenvolvimento ─── */}
        <div className={sectionClass}>
          <h2 className="text-sm font-semibold text-slate-800 dark:text-[#fafafa] mb-3">Sono e Desenvolvimento</h2>
        ...
        {/* ─── Seção 7: Orientações Finais ─── */}
        <div className={sectionClass}>
          <h2 className="text-sm font-semibold text-slate-800 dark:text-[#fafafa] mb-3">Orientações Finais</h2>
