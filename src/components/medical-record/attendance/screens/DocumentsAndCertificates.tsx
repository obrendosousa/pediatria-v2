    ...
    <div className="flex h-full min-h-0">
      ...
      <div className="w-72 flex-shrink-0 border-r border-slate-200 dark:border-[#3d3d48] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          {isLoading ? (
            <div className="p-6 text-center text-slate-400 dark:text-[#71717a] text-sm">
              Carregando...
            </div>
          ) : documents.length === 0 ? (
            <div className="p-6 text-center">
              <FileText className="w-10 h-10 text-slate-300 dark:text-gray-600 mx-auto mb-2" />
              <p className="text-sm text-slate-400 dark:text-[#71717a]">Nenhum documento</p>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {isEditing ? (
          <>
            ...
            <div className="px-6 py-4 border-b border-slate-200 dark:border-[#3d3d48] flex items-center justify-between gap-4 flex-wrap">
              <div className="flex items-center gap-3 flex-wrap">
                {/* Tipo do documento */}
                <div className="flex items-center gap-2">
                  <label className="text-xs font-medium text-slate-500 dark:text-[#a1a1aa] whitespace-nowrap">
                    Tipo:
                  </label>
                  <select
                    value={docType}
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-sm text-slate-600 dark:text-[#d4d4d8] hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                >
                  {requiresSignature ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
            ...
            <p className="text-sm text-slate-400 dark:text-[#71717a] max-w-xs mb-6">
