...
export function AttendanceSidebar({
  ...
  return (
    <div className="w-64 shrink-0 bg-white dark:bg-[#0a0a0c] border-r border-slate-200 dark:border-[#27272a] flex flex-col h-full">
            ...
            if (entry.type === 'submenu') {
              ...
              return (
                <div key={`submenu-${idx}`}>
                  ...
                  {isOpen && (
                    <div className="ml-4 pl-3 border-l border-slate-100 dark:border-[#2e2e33] space-y-0.5 mt-0.5">
      ...
      {isConsultationActive && (
        <div className="p-4 border-t border-slate-200 dark:border-[#27272a]">
          <button
