  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 md:p-8 space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex gap-3 w-full md:w-auto">
           ...
           <div className="relative flex-1 md:w-80">
             ...
             <input 
               ...
               className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 dark:border-[#3d3d48] bg-white dark:bg-[#08080b] text-slate-700 dark:text-gray-200 focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500 transition-all outline-none"
               value={searchTerm}
       ...
       {/* --- TABELA DE DADOS --- */}
       <div className="bg-white dark:bg-[#08080b] rounded-2xl border border-slate-200 dark:border-[#2d2d36] shadow-sm">
         <div className="overflow-x-auto overflow-y-visible relative">
           <table className="w-full text-left text-sm">
            <thead className="bg-slate-50 dark:bg-[#252830] border-b border-slate-100 dark:border-[#2d2d36]">
              <tr>
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-slate-100 dark:bg-[#1c1c21] text-slate-500 dark:text-[#a1a1aa] group-hover:bg-rose-100 group-hover:text-rose-600 dark:group-hover:bg-rose-900/40 dark:group-hover:text-rose-400 flex items-center justify-center font-bold text-sm transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      ...
                      >
                        <button 
                          ...
                          className="p-2 hover:bg-slate-200 dark:hover:bg-[#2d2d36] rounded-full transition-colors text-slate-400 relative z-10"
                        >
      ...
      {menuOpenId !== null && menuPosition && (
        <div 
          ref={dropdownMenuRef}
          className="fixed bg-white dark:bg-[#1c1c21] shadow-xl rounded-lg border border-slate-200 dark:border-[#3d3d48] py-1 w-48 z-[200] animate-in fade-in zoom-in-95 duration-100 overflow-hidden"
          style={{
