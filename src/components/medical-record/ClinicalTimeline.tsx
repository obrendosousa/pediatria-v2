  ...
  if (!loading && entries.length === 0) {
    return (
      <div className="text-center py-16 bg-slate-50 dark:bg-[#08080b]/50 rounded-3xl border-2 border-dashed border-slate-200 dark:border-[#2d2d36]">
        ...
        <p className="text-slate-500 dark:text-[#71717a] text-sm">O histórico aparecerá aqui conforme registros forem criados.</p>
      </div>
    );
  }
    ...
    <div className="space-y-4">
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="flex items-end gap-4 flex-wrap">
              <div className="min-w-[200px]">
                <label className="text-xs font-bold text-slate-500 dark:text-[#a1a1aa] uppercase mb-1 block">Profissional</label>
                <select
              ...
              <div>
                <label className="text-xs font-bold text-slate-500 dark:text-[#a1a1aa] uppercase mb-1 block">De</label>
                <input
                  type="date"
              ...
              <div>
                <label className="text-xs font-bold text-slate-500 dark:text-[#a1a1aa] uppercase mb-1 block">Até</label>
                <input
                  type="date"
                  value={filterDateTo}
            ...
            {/* Tipos de registro */}
            <div>
              <label className="text-xs font-bold text-slate-500 dark:text-[#a1a1aa] uppercase mb-2 block">Tipo de registro</label>
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-sm text-slate-400 dark:text-[#71717a]">Nenhum registro corresponde aos filtros.</p>
        </div>
      ) : (
                      ...
                      >
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="flex-1 min-w-0">
                            ...
                            <h4 className="font-bold text-slate-800 dark:text-[#fafafa] text-sm truncate">
                              {entry.title}
                            </h4>
                            <div className="flex items-center gap-3 mt-1 text-xs text-slate-400 dark:text-[#71717a]">
                        ...
                        {!isExpanded && entry.preview && (
                          <p className="mt-2 text-xs text-slate-500 dark:text-[#a1a1aa] line-clamp-2">{entry.preview}</p>
                        )}
                        ...
                        {isExpanded && (
                          <div className="mt-4 pt-4 border-t border-slate-100 dark:border-[#2d2d36]">
                            {entry.htmlContent ? (
                              ...
                              <p className="text-sm text-slate-600 dark:text-[#d4d4d8] whitespace-pre-wrap">{entry.preview}</p>
                            )}
                          </div>
                        )}
                      </div>
