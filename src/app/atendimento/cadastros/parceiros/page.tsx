...
const inputClass =
  'w-full px-3 py-2.5 text-sm border border-slate-200 dark:border-gray-700 rounded-xl bg-white dark:bg-[#2a2d36] text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-400';

const inputErrorClass =
  'w-full px-3 py-2.5 text-sm border border-red-300 dark:border-red-700 rounded-xl bg-white dark:bg-[#2a2d36] text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-red-400';

const labelClass =
  'block text-xs font-bold text-slate-500 dark:text-gray-400 uppercase tracking-wider mb-1.5 ml-1';
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-gray-700 bg-white dark:bg-[#1e2028]">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-bold text-slate-800 dark:text-gray-100">Parceiros</h1>
        </div>
        <button
          onClick={openCreate}
