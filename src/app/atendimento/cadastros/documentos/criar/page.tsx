...
export default function CriarDocumentoPage() {
  ...
  }, [title, content, isDefault, createTemplate, toast, router]);
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-[#252a3a] bg-white dark:bg-[#0d0f15]">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 dark:text-[#565d73]">Crie um modelo de documento com variáveis</p>
          </div>
        </div>
      </div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                  isDefault ? 'bg-teal-600' : 'bg-slate-300 dark:bg-gray-600'
                }`}
              >
                <span
