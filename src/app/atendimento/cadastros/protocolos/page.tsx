...
export default function ProtocolosClinicoPage() {
  ...
  const [deleteTarget, setDeleteTarget] = useState<ClinicalProtocol | null>(null);
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-[#252530] bg-white dark:bg-[#111118]">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-bold text-slate-800 dark:text-[#fafafa]">Protocolos Clínicos</h1>
        </div>
        <button
