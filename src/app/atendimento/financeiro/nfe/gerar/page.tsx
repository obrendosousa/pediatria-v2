    ...
    <div className="h-full flex flex-col bg-slate-50 dark:bg-[#15171e]">
      ...
      <div className="px-6 py-4 flex items-center gap-4 border-b border-slate-200 dark:border-[#252a3a] bg-white dark:bg-[#0d0f15]">
        ...
        <div>
          ...
          <p className="text-xs text-slate-400 dark:text-[#565d73]">Preencha os dados para emissão da nota fiscal</p>
        </div>
      </div>
          ...
          <section className="bg-white dark:bg-[#0d0f15] rounded-xl border border-slate-200 dark:border-[#252a3a] p-6 space-y-5">
            ...
            <div className="grid grid-cols-12 gap-4">
              ...
              <div className="col-span-12 md:col-span-4">
                <label className="text-xs font-bold text-slate-500 dark:text-[#828ca5] mb-1 ml-1 block uppercase tracking-wider">CPF/CNPJ</label>
                <input
                  type="text"
                  value={taxpayerDoc}
              ...
              <div className="col-span-12 md:col-span-5">
                <label className="text-xs font-bold text-slate-500 dark:text-[#828ca5] mb-1 ml-1 block uppercase tracking-wider">Nome / Razão Social</label>
                <input
                  type="text"
                  value={taxpayerName}
              ...
              <div className="col-span-12 md:col-span-3">
                <label className="text-xs font-bold text-slate-500 dark:text-[#828ca5] mb-1 ml-1 block uppercase tracking-wider">E-mail</label>
                <input
                  type="email"
                  value={taxpayerEmail}
              ...
              <div className="col-span-6 md:col-span-2">
                <label className="text-xs font-bold text-slate-500 dark:text-[#828ca5] mb-1 ml-1 block uppercase tracking-wider">CEP</label>
                <input
                  type="text"
                  value={cep}
              ...
              {/* Estado */}
              <div className="col-span-6 md:col-span-2">
                <label className="text-xs font-bold text-slate-500 dark:text-[#828ca5] mb-1 ml-1 block uppercase tracking-wider">Estado</label>
                <input
                  type="text"
                  value={estado}
              ...
              <div className="col-span-6 md:col-span-4">
                <label className="text-xs font-bold text-slate-500 dark:text-[#828ca5] mb-1 ml-1 block uppercase tracking-wider">Cidade</label>
                <input
                  type="text"
                  value={cidade}
              ...
              {/* Bairro */}
              <div className="col-span-6 md:col-span-4">
                <label className="text-xs font-bold text-slate-500 dark:text-[#828ca5] mb-1 ml-1 block uppercase tracking-wider">Bairro</label>
                <input
                  type="text"
                  value={bairro}
              ...
              <div className="col-span-12 md:col-span-6">
                <label className="text-xs font-bold text-slate-500 dark:text-[#828ca5] mb-1 ml-1 block uppercase tracking-wider">Endereço</label>
                <input
                  type="text"
                  value={endereco}
              ...
              <div className="col-span-4 md:col-span-2">
                <label className="text-xs font-bold text-slate-500 dark:text-[#828ca5] mb-1 ml-1 block uppercase tracking-wider">Número</label>
                <input
                  type="text"
                  value={numero}
              ...
              <div className="col-span-8 md:col-span-4">
                <label className="text-xs font-bold text-slate-500 dark:text-[#828ca5] mb-1 ml-1 block uppercase tracking-wider">Complemento</label>
                <input
                  type="text"
                  value={complemento}
          ...
          <section className="bg-white dark:bg-[#0d0f15] rounded-xl border border-slate-200 dark:border-[#252a3a] p-6 space-y-5">
            ...
            <div className="grid grid-cols-12 gap-4">
              ...
              <div className="col-span-12">
                <label className="text-xs font-bold text-slate-500 dark:text-[#828ca5] mb-1 ml-1 block uppercase tracking-wider">
              ...
              {/* Observações */}
              <div className="col-span-12">
                <label className="text-xs font-bold text-slate-500 dark:text-[#828ca5] mb-1 ml-1 block uppercase tracking-wider">Observações</label>
                <textarea
                  value={notes}
              ...
              <div className="col-span-6 md:col-span-3">
                ...
                <input
                  ...
                  placeholder="0,00"
                  className="w-full px-3 py-2.5 text-sm border border-slate-200 dark:border-[#252a3a] rounded-xl bg-white dark:bg-[#141722] text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-400 text-right font-mono"
                />
              </div>

              {/* Serviço */}
              <div className="col-span-6 md:col-span-3">
                <label className="text-xs font-bold text-slate-500 dark:text-[#828ca5] mb-1 ml-1 block uppercase tracking-wider">Serviço</label>
                <select
                  value={serviceCode}
                  onChange={e => setServiceCode(e.target.value)}
                  className="w-full px-3 py-2.5 text-sm border border-slate-200 dark:border-[#252a3a] rounded-xl bg-white dark:bg-[#141722] text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-400 appearance-none cursor-pointer"
                >
              ...
              {/* Impostos */}
              <div className="col-span-12">
                <p className="text-xs font-bold text-slate-500 dark:text-[#828ca5] mb-2 ml-1 uppercase tracking-wider">Impostos (opcional)</p>
                <div className="grid grid-cols-5 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="0,00"
                      className="w-full px-2 py-2 text-xs border border-slate-200 dark:border-[#252a3a] rounded-lg bg-white dark:bg-[#141722] text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-400 text-right font-mono"
                    />
                  </div>
                  <div>
              ...
              <div className="col-span-12 flex flex-wrap items-center gap-6 pt-2">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-slate-700 dark:text-[#a0a8be]">ISS retido na fonte</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                    ...
                    className="w-4 h-4 rounded border-slate-300 text-teal-600 focus:ring-teal-500"
                  />
                  <span className="text-sm text-slate-700 dark:text-[#a0a8be]">Enviar nota por e-mail</span>
                </label>
              </div>
            </div>
          </section>
