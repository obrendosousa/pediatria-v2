    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#16171c] transition-colors">
      ...
      <div className="h-16 px-6 flex items-center justify-between bg-white dark:bg-[#0a0a0c] border-b border-slate-100 dark:border-[#27272a] shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-bold text-slate-800 dark:text-[#fafafa] leading-none">Gerenciar Agendamentos</h1>
      ...
      <div className="px-6 py-4">
        <div className="bg-white dark:bg-[#0a0a0c] rounded-xl border border-slate-200 dark:border-[#27272a] p-4 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
            {/* Paciente */}
            <div>
              <label className="block text-[11px] font-bold text-slate-500 dark:text-[#a1a1aa] mb-1">Paciente</label>
            ...
            {/* Procedimento */}
            <div>
              <label className="block text-[11px] font-bold text-slate-500 dark:text-[#a1a1aa] mb-1">Procedimento</label>
              <select
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-slate-100 dark:border-[#27272a] bg-slate-50 dark:bg-[#16171c]">
                      ...
                      <th className="px-4 py-3 text-center text-[11px] font-bold text-slate-500 dark:text-[#a1a1aa] uppercase tracking-wider">Opções</th>
                    </tr>
                  </thead>
                    ...
                    {appointments.map(appt => (
                      <tr key={appt.id} className="hover:bg-slate-50/50 dark:hover:bg-white/[0.02] transition-colors">
                        <td className="px-4 py-3">
                          ...
                          {appt.patient_phone && (
                            <p className="text-[11px] text-slate-400 dark:text-[#71717a]">{appt.patient_phone}</p>
                          )}
                        </td>
                        <td className="px-4 py-3">
                          <p className="text-xs text-slate-600 dark:text-[#d4d4d8] truncate max-w-[220px]">
