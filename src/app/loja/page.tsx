...
export default function StorePage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#f8fafc] dark:bg-[#0b141a] overflow-hidden transition-colors duration-300">
      ...
      {/* HEADER DA LOJA */}
      <div className="bg-white dark:bg-[#08080b] px-8 py-5 border-b border-slate-200 dark:border-[#2d2d36] flex justify-between items-center shrink-0 transition-colors">
         <div>
         ...
         <div className="flex bg-slate-100 dark:bg-[#1c1c21] p-1 rounded-xl transition-colors">
            {[
               ...
               <button
                  ...
                  className={`flex items-center gap-2 px-6 py-2.5 rounded-lg text-sm font-bold transition-all ${
                     activeTab === tab.id 
                     ? 'bg-white dark:bg-[#08080b] text-rose-600 dark:text-rose-400 shadow-sm' 
      ...
      <div className="flex-1 overflow-hidden relative">
            ...
            <div className="h-full overflow-y-auto p-8 custom-scrollbar">
               ...
               {loadingMetrics ? (
                  <div className="grid grid-cols-4 gap-6 mb-8">
                     {[1, 2, 3, 4].map(i => (
                        <div key={i} className="bg-white dark:bg-[#08080b] p-5 rounded-2xl border border-slate-100 dark:border-[#2d2d36] shadow-sm animate-pulse">
               ...
               <div className="bg-white dark:bg-[#08080b] p-4 rounded-2xl border border-slate-100 dark:border-[#2d2d36] shadow-sm mb-6">
                  <div className="flex items-center gap-2 mb-3">
                    <ShieldCheck className="w-4 h-4 text-emerald-500" />
                    <h3 className="text-sm font-bold text-slate-700 dark:text-gray-200">Operações e Segurança</h3>
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
                    <button onClick={() => handleTabChange('pos')} className="px-3 py-2 rounded-lg border border-slate-200 dark:border-[#3d3d48] text-xs font-bold text-slate-600 dark:text-[#d4d4d8] hover:bg-slate-50 dark:hover:bg-white/5">Abrir checkout</button>
                    <button onClick={() => setShowScanner(true)} className="px-3 py-2 rounded-lg border border-slate-200 dark:border-[#3d3d48] text-xs font-bold text-slate-600 dark:text-[#d4d4d8] hover:bg-slate-50 dark:hover:bg-white/5">Scanner mobile</button>
                    <button onClick={() => handleTabChange('cash')} className="px-3 py-2 rounded-lg border border-slate-200 dark:border-[#3d3d48] text-xs font-bold text-slate-600 dark:text-[#d4d4d8] hover:bg-slate-50 dark:hover:bg-white/5">Fechar caixa loja</button>
                    <button onClick={exportOperationalReport} className="px-3 py-2 rounded-lg border border-slate-200 dark:border-[#3d3d48] text-xs font-bold text-slate-600 dark:text-[#d4d4d8] hover:bg-slate-50 dark:hover:bg-white/5">Exportar logs</button>
                    <button onClick={() => handleTabChange('catalog')} className="px-3 py-2 rounded-lg border border-slate-200 dark:border-[#3d3d48] text-xs font-bold text-slate-600 dark:text-[#d4d4d8] hover:bg-slate-50 dark:hover:bg-white/5">Auditoria catálogo</button>
                  </div>
               </div>

               <div className="grid grid-cols-3 gap-6">
                  {/* Gráfico de Vendas */}
                  <div className="col-span-2 bg-white dark:bg-[#08080b] p-6 rounded-3xl border border-slate-100 dark:border-[#2d2d36] shadow-sm h-[400px] flex flex-col transition-colors">
                  ...
                  <div className="bg-white dark:bg-[#08080b] p-6 rounded-3xl border border-slate-100 dark:border-[#2d2d36] shadow-sm flex flex-col transition-colors">
                        ...
                        {loadingMetrics ? (
                           ...
                           metrics.expiringList.map((item: any, i: number) => (
                              <div key={i} className="flex justify-between items-center p-3 bg-rose-50 dark:bg-rose-900/10 rounded-xl border border-rose-100 dark:border-rose-900/20">
                                 ...
                                 <div className="bg-white dark:bg-[#08080b] px-3 py-1 rounded-lg text-xs font-bold text-slate-600 dark:text-[#d4d4d8] shadow-sm">
                                    {item.quantity} un
                                 </div>
                              </div>
                           ))
                     ...
                     <div className="mt-4 grid grid-cols-2 gap-2">
                        <button
                           ...
                           className="w-full py-2 text-xs font-bold text-slate-500 dark:text-[#a1a1aa] hover:text-rose-500 dark:hover:text-rose-400 transition-colors border border-slate-200 dark:border-[#3d3d48] rounded-lg"
                        >
                           Visão financeira
                        </button>
                        <button
         ...
         {activeTab === 'pos' && (
            <div className="h-full flex">
               ...
               <div className="flex-1 flex flex-col p-6 pr-3 border-r border-slate-200 dark:border-[#2d2d36]">
                  <div className="mb-6 flex gap-3">
                     <div className="relative flex-1">
                        <Search className="absolute left-3 top-3 w-5 h-5 text-slate-400 dark:text-[#71717a]" />
                        <input 
                           className="w-full pl-10 pr-4 py-3 bg-white dark:bg-[#08080b] border border-slate-200 dark:border-[#3d3d48] rounded-xl focus:outline-none focus:ring-2 focus:ring-rose-500 dark:focus:ring-rose-900 transition-all shadow-sm text-slate-700 dark:text-gray-200 placeholder:text-slate-400 dark:placeholder:text-gray-600"
                     ...
                     <button
                        ...
                        className="px-4 py-3 bg-white dark:bg-[#08080b] border border-slate-200 dark:border-[#3d3d48] rounded-xl font-bold text-sm text-slate-700 dark:text-[#d4d4d8] hover:bg-slate-50 dark:hover:bg-white/5 transition-all flex items-center gap-2"
                     >
                           ...
                           <div key={product.id} onClick={() => (product.stock || 0) > 0 && addToCart(product)} className={`bg-white dark:bg-[#08080b] p-4 rounded-2xl border border-slate-100 dark:border-[#3d3d48] shadow-sm transition-all group relative overflow-hidden flex flex-col h-[200px] ${(product.stock || 0) > 0 ? 'hover:border-rose-300 dark:hover:border-rose-700 hover:shadow-md cursor-pointer' : 'opacity-60 cursor-not-allowed'}`}>
                              <div className="flex-1 bg-slate-50 dark:bg-[#1c1c21] rounded-xl mb-3 flex items-center justify-center relative overflow-hidden">
                                 ...
                                 <div className="absolute inset-0 bg-rose-500/10 dark:bg-rose-500/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <Plus className="w-8 h-8 text-rose-600 dark:text-rose-400 bg-white dark:bg-[#08080b] rounded-full p-1 shadow-sm" />
                                 </div>
                              </div>
                              <div>
               ...
               {/* Direita: Carrinho */}
               <div className="w-[420px] bg-white dark:bg-[#08080b] flex flex-col z-10 shadow-xl border-l border-slate-100 dark:border-[#2d2d36] transition-colors">
                  {/* Cliente */}
                  <div className="p-6 border-b border-slate-100 dark:border-[#2d2d36]">
                     ...
                     <div className="relative">
                        ...
                        <input
                           type="text"
                           className="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-[#1c1c21] border border-slate-200 dark:border-[#3d3d48] rounded-xl text-sm font-bold text-slate-700 dark:text-gray-200 focus:outline-none focus:border-rose-400 dark:focus:border-rose-700"
                     ...
                     {patientSearchTerm && (
                        <div className="mt-2 max-h-48 overflow-y-auto custom-scrollbar border border-slate-200 dark:border-[#3d3d48] rounded-lg bg-white dark:bg-[#08080b]">
                           {patients
                              ...
                              .map(p => (
                                 <button
                                    ...
                                    className={`w-full text-left px-4 py-2.5 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors border-b border-slate-100 dark:border-[#2d2d36] last:border-0 ${
                  ...
                  {/* Totais e Ações */}
                  <div className="p-6 bg-slate-50 dark:bg-[#111b21] border-t border-slate-200 dark:border-[#2d2d36] transition-colors">
                    ...
                    <div className="mb-3">
                      ...
                      <div className="grid grid-cols-2 gap-2 mb-2">
                        <button onClick={() => setSelectedPaymentMethod('cash')} className={`py-2 rounded-lg font-bold text-xs border ${selectedPaymentMethod === 'cash' ? 'bg-emerald-50 dark:bg-emerald-900/20 border-emerald-300 dark:border-emerald-800 text-emerald-700 dark:text-emerald-400' : 'bg-white dark:bg-[#1c1c21] border-slate-200 dark:border-[#3d3d48] text-slate-600 dark:text-[#d4d4d8]'}`}>Dinheiro</button>
                        <button onClick={() => setSelectedPaymentMethod('pix')} className={`py-2 rounded-lg font-bold text-xs border ${selectedPaymentMethod === 'pix' ? 'bg-teal-50 dark:bg-teal-900/20 border-teal-300 dark:border-teal-800 text-teal-700 dark:text-teal-400' : 'bg-white dark:bg-[#1c1c21] border-slate-200 dark:border-[#3d3d48] text-slate-600 dark:text-[#d4d4d8]'}`}>Pix</button>
                      </div>
                      <div className="grid grid-cols-3 gap-2">
                        <button onClick={() => setSelectedPaymentMethod('credit_card')} className={`py-2 rounded-lg font-bold text-xs border ${selectedPaymentMethod === 'credit_card' ? 'bg-slate-100 dark:bg-slate-700 border-slate-400 dark:border-slate-500 text-slate-800 dark:text-white' : 'bg-white dark:bg-[#1c1c21] border-slate-200 dark:border-[#3d3d48] text-slate-600 dark:text-[#d4d4d8]'}`}>Crédito</button>
                        <button onClick={() => setSelectedPaymentMethod('debit_card')} className={`py-2 rounded-lg font-bold text-xs border ${selectedPaymentMethod === 'debit_card' ? 'bg-indigo-50 dark:bg-indigo-900/20 border-indigo-300 dark:border-indigo-800 text-indigo-700 dark:text-indigo-300' : 'bg-white dark:bg-[#1c1c21] border-slate-200 dark:border-[#3d3d48] text-slate-600 dark:text-[#d4d4d8]'}`}>Débito</button>
                        <button onClick={() => setSelectedPaymentMethod('mixed')} className={`py-2 rounded-lg font-bold text-xs border ${selectedPaymentMethod === 'mixed' ? 'bg-amber-50 dark:bg-amber-900/20 border-amber-300 dark:border-amber-800 text-amber-700 dark:text-amber-400' : 'bg-white dark:bg-[#1c1c21] border-slate-200 dark:border-[#3d3d48] text-slate-600 dark:text-[#d4d4d8]'}`}>Misto</button>
                      </div>
                    </div>

                    {selectedPaymentMethod === 'cash' && (
                        <div className="mb-4 p-4 bg-white dark:bg-[#1c1c21] rounded-xl border border-slate-200 dark:border-[#3d3d48]">
                           ...
                           <input
                              ...
                              className="w-full px-4 py-2.5 bg-slate-50 dark:bg-[#08080b] border border-slate-200 dark:border-[#3d3d48] rounded-lg text-lg font-bold text-slate-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-rose-500"
                              placeholder="0.00"
                           />
                           {parseFloat(cashAmount || '0') >= cartTotal && (
                              <div className="mt-3 pt-3 border-t border-slate-200 dark:border-[#3d3d48]">
                    ...
                    {selectedPaymentMethod === 'mixed' && (
                      <div className="mb-3 p-3 bg-white dark:bg-[#1c1c21] rounded-xl border border-slate-200 dark:border-[#3d3d48]">
                        <div className="grid grid-cols-2 gap-2">
                          <input type="number" step="0.01" min="0" value={mixedAmounts.pix} onChange={(e) => setMixedAmounts((prev) => ({ ...prev, pix: e.target.value }))} className="px-2 py-2 bg-slate-50 dark:bg-[#08080b] border border-slate-200 dark:border-[#3d3d48] rounded text-xs font-bold" placeholder="Pix" />
                          <input type="number" step="0.01" min="0" value={mixedAmounts.cash} onChange={(e) => setMixedAmounts((prev) => ({ ...prev, cash: e.target.value }))} className="px-2 py-2 bg-slate-50 dark:bg-[#08080b] border border-slate-200 dark:border-[#3d3d48] rounded text-xs font-bold" placeholder="Dinheiro" />
                          <input type="number" step="0.01" min="0" value={mixedAmounts.credit_card} onChange={(e) => setMixedAmounts((prev) => ({ ...prev, credit_card: e.target.value }))} className="px-2 py-2 bg-slate-50 dark:bg-[#08080b] border border-slate-200 dark:border-[#3d3d48] rounded text-xs font-bold" placeholder="Crédito" />
                          <input type="number" step="0.01" min="0" value={mixedAmounts.debit_card} onChange={(e) => setMixedAmounts((prev) => ({ ...prev, debit_card: e.target.value }))} className="px-2 py-2 bg-slate-50 dark:bg-[#08080b] border border-slate-200 dark:border-[#3d3d48] rounded text-xs font-bold" placeholder="Débito" />
                        </div>
                      </div>
                    )}
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        ...
                        className="py-3 bg-white dark:bg-[#1c1c21] border border-slate-200 dark:border-[#3d3d48] rounded-xl font-bold text-slate-600 dark:text-[#d4d4d8] text-sm hover:bg-slate-50 dark:hover:bg-white/5 transition-all"
                      >
                        Consumidor final
                      </button>
                      <button
            ...
            <div className="h-full p-8 overflow-y-auto custom-scrollbar">
               <div className="flex justify-between items-center mb-6">
                  ...
                  <div className="flex gap-3">
                     <button 
                        onClick={fetchData}
                        className="bg-slate-100 dark:bg-[#1c1c21] text-slate-700 dark:text-[#d4d4d8] px-4 py-2.5 rounded-xl font-bold text-sm hover:bg-slate-200 dark:hover:bg-white/10 flex items-center gap-2 transition-all"
               ...
               <div className="bg-white dark:bg-[#08080b] rounded-2xl border border-slate-200 dark:border-[#2d2d36] p-4 mb-4 grid grid-cols-4 gap-3">
                  <input
                     value={catalogSearchTerm}
                     onChange={(e) => setCatalogSearchTerm(e.target.value)}
                     placeholder="Buscar por nome ou código"
                     className="col-span-2 px-3 py-2 rounded-lg bg-slate-50 dark:bg-[#1c1c21] border border-slate-200 dark:border-[#3d3d48] text-sm font-semibold text-slate-700 dark:text-gray-200"
                  />
                  <select
                    value={catalogCategoryFilter}
                    onChange={(e) => setCatalogCategoryFilter(e.target.value)}
                    className="px-3 py-2 rounded-lg bg-slate-50 dark:bg-[#1c1c21] border border-slate-200 dark:border-[#3d3d48] text-sm font-semibold text-slate-700 dark:text-gray-200"
                  >
               ...
               <div className="bg-white dark:bg-[#08080b] rounded-3xl border border-slate-200 dark:border-[#2d2d36] shadow-sm overflow-hidden transition-colors">
                  <table className="w-full text-left">
                     <thead className="bg-slate-50 dark:bg-[#1c1c21] border-b border-slate-100 dark:border-[#3d3d48]">
                        <tr>
            ...
            <div className="h-full p-8 overflow-y-auto custom-scrollbar">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-2">
                  <button onClick={fetchStoreCash} className="px-4 py-2 rounded-xl border border-slate-200 dark:border-[#3d3d48] text-sm font-bold text-slate-600 dark:text-[#d4d4d8] hover:bg-slate-50 dark:hover:bg-white/5">
                    Atualizar
                  </button>
                  <button
              ...
              {loadingStoreCash ? (
                <div className="bg-white dark:bg-[#08080b] rounded-2xl border border-slate-100 dark:border-[#2d2d36] p-8 text-center text-slate-500 dark:text-[#a1a1aa]">
                ...
                <>
                  ...
                  <div className="bg-white dark:bg-[#08080b] rounded-2xl border border-slate-100 dark:border-[#2d2d36] shadow-sm overflow-hidden">
                    <div className="px-5 py-4 border-b border-slate-100 dark:border-[#2d2d36] flex items-center justify-between">
                    ...
                    <div className="max-h-[420px] overflow-y-auto custom-scrollbar">
                      {storeCashData.transactions.length === 0 ? (
                        ...
                        <table className="w-full text-sm">
                          <thead className="bg-slate-50 dark:bg-[#1c1c21] sticky top-0">
                            <tr>
                          ...
                          <tbody>
                            {storeCashData.transactions.map((transaction) => (
                              <tr key={transaction.id} className="border-t border-slate-100 dark:border-[#2d2d36]">
        ...
        {showScanner && (
           ...
           >
              <div
                 className="bg-white dark:bg-[#08080b] rounded-3xl shadow-2xl max-w-md w-full p-6"
              ...
              >
                 ...
                 <div className="bg-slate-50 dark:bg-[#1c1c21] border border-slate-200 dark:border-[#3d3d48] rounded-2xl p-4 flex items-center justify-center mb-3">
...
function MetricCard({ title, value, icon: Icon, color, trend, subtext }: any) {
   ...
   return (
      <div className="bg-white dark:bg-[#08080b] p-5 rounded-2xl border border-slate-100 dark:border-[#2d2d36] shadow-sm flex flex-col transition-colors">
