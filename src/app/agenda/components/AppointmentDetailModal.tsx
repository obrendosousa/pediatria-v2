                ...
                <div className="space-y-2 mt-2">
                  <div>
                    ...
                    <div className="flex gap-0 bg-slate-100 dark:bg-slate-800 p-1 rounded-lg mt-1">
                      <button type="button" onClick={() => setEditForm({ ...editForm, patient_sex: 'M' })} className={`flex-1 py-1.5 text-xs font-medium rounded-md transition-all ${editForm.patient_sex === 'M' ? 'bg-white text-blue-600 shadow-sm dark:bg-[#1c1c21] dark:text-blue-400' : 'text-slate-500 hover:text-slate-700 dark:text-slate-400'}`}>Masculino</button>
                      <button type="button" onClick={() => setEditForm({ ...editForm, patient_sex: 'F' })} className={`flex-1 py-1.5 text-xs font-medium rounded-md transition-all ${editForm.patient_sex === 'F' ? 'bg-white text-pink-600 shadow-sm dark:bg-[#1c1c21] dark:text-pink-400' : 'text-slate-500 hover:text-slate-700 dark:text-slate-400'}`}>Feminino</button>
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full text-xs font-medium text-slate-700 dark:text-gray-200 border border-slate-200 dark:border-gray-600 rounded-md px-2 py-1.5 focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400/20 outline-none bg-white dark:bg-[#1c1c21] transition-all mt-1"
                    >
