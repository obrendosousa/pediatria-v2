  ...
  return (
    <div className="h-16 px-6 flex items-center justify-between bg-white dark:bg-[#0a0a0c] border-b border-slate-100 dark:border-[#27272a] shadow-sm z-20 transition-colors">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-base font-bold text-slate-800 dark:text-[#fafafa] leading-none">Agenda da Dra.</h1>
          <p className="text-xs text-slate-500 dark:text-[#a1a1aa] mt-0.5">Visão Geral da Unidade</p>
        </div>
      </div>
