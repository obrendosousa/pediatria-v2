    ...
    <div className="h-full flex flex-col bg-[#f8fafc] dark:bg-[#0b141a] overflow-hidden transition-colors duration-300">
      ...
      <div className="flex-1 flex flex-col sm:flex-row gap-4 sm:gap-6 p-3 sm:p-6 overflow-hidden">
                                    ...
                                    <div 
                                        ...
                                        className={`
                                            ...
                                            ${isToday 
                                                ...
                                                : 'border-slate-200 dark:border-[#3d3d48] dark:bg-[#1c1c21] hover:border-indigo-300 dark:hover:border-indigo-600 bg-white'
                                            }
                                        `}
                                    >
                                        {/* Número do dia */}
                ...
                {viewMode === 'day' && (
                    <div className="pb-10 min-h-full">
                        {tasksByHour['none'] && tasksByHour['none'].length > 0 && (
                            <div className="p-4 border-b border-slate-100 dark:border-[#3d3d48] bg-white/50 dark:bg-[#202c33]/50 mb-2">
                        ...
                        {HOURS.map(hour => {
                            ...
                            return (
                                <div key={hour} className="flex min-h-[100px] border-b border-slate-100 dark:border-[#2d2d36] relative group">
                                    ...
                                    <div className="w-16 border-r border-slate-100 dark:border-[#2d2d36] py-2 text-right pr-3 text-xs font-bold text-slate-400 dark:text-[#71717a] bg-white/50 dark:bg-[#08080b]">
                                        {hour}:00
                                    </div>
        ...
        <div className="w-full sm:w-80 bg-slate-50 dark:bg-[#08080b] rounded-xl sm:rounded-2xl border border-slate-200 dark:border-[#3d3d48] flex flex-col overflow-hidden transition-colors">
            <div className="p-4 border-b border-slate-200 dark:border-[#3d3d48] bg-white/50 dark:bg-[#202c33] flex flex-col gap-3">
