...
const TIPO_COLORS: Record<string, string> = {
  ...
  geral: "bg-gray-100 text-gray-700 dark:bg-[#1c1c21] dark:text-[#d4d4d8]",
};
...
export default function ReportViewer({ report }: { report: Report }) {
  ...
  return (
    <div className="h-full overflow-y-auto custom-scrollbar bg-gray-50 dark:bg-[#0b141a] print:bg-white print:overflow-visible">
      {/* Header */}
      <div className="sticky top-0 z-10 border-b border-gray-200 dark:border-[#2d2d36] bg-white/90 dark:bg-[#111b21]/90 backdrop-blur-sm print:hidden">
        <div className="mx-auto max-w-4xl px-4 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-sm px-3 py-1.5 rounded-lg border border-gray-200 dark:border-[#3d3d48] hover:bg-gray-100 dark:hover:bg-[#1c1c21] text-gray-600 dark:text-[#d4d4d8] transition-colors"
            >
              <Printer size={14} />
              Imprimir
            </button>
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 print:py-6">
        ...
        <div className="mb-8 print:mb-6">
          ...
          <hr className="mt-6 border-gray-200 dark:border-[#3d3d48] print:border-gray-300" />
        </div>
        ...
        {/* Rodapé */}
        <div className="mt-12 pt-6 border-t border-gray-200 dark:border-[#3d3d48] print:mt-8">
