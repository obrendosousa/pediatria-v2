        ...
        <div className="z-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-[#a1a1aa] font-medium mt-1">
              ...
              return (
                <button
                  ...
                  className={`flex items-center justify-center gap-2 py-3 px-6 rounded-xl text-sm font-bold transition-all duration-300 ${isActive
                    ...
                    : 'text-slate-500 dark:text-[#a1a1aa] hover:text-slate-700 dark:hover:text-gray-200 hover:bg-white/50 dark:hover:bg-white/5'
                    }`}
                >
                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 bg-white dark:bg-[#08080b] p-6 rounded-3xl border border-slate-200 dark:border-[#3d3d48] shadow-sm">
                    <div className="max-w-2xl">
                      ...
                      <h2 className="text-xl font-black text-slate-800 dark:text-[#fafafa] mb-2">Marcos de Idade</h2>
                      <p className="text-sm text-slate-500 dark:text-[#a1a1aa] leading-relaxed">
                  ...
                  {milestoneAutomations.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center p-16 bg-white dark:bg-[#08080b] border border-slate-200 dark:border-[#3d3d48] border-dashed rounded-[2rem] text-center">
                      ...
                      <h3 className="text-xl font-bold text-slate-800 dark:text-[#fafafa] mb-3">Nenhuma automação configurada</h3>
                      <p className="text-slate-500 dark:text-[#a1a1aa] max-w-sm mb-8 text-sm leading-relaxed">Comece criando uma mensagem especial para quando o bebê completar 1 mês de vida para dar início a jornada.</p>
                      <button
                        onClick={handleCreateMilestone}
              ...
              {activeTab === 'appointment' && (
                <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-4xl mx-auto mt-4">
                  <div className="text-center mb-10">
                    ...
                    <h2 className="text-2xl font-black text-slate-800 dark:text-[#fafafa] mb-3">Lembretes de Consulta</h2>
                    <p className="text-slate-500 dark:text-[#a1a1aa] mx-auto max-w-xl text-sm leading-relaxed">
                  ...
                  {appointmentAutomation ? (
                    ...
                    <div className="flex flex-col items-center justify-center p-16 bg-white dark:bg-[#08080b] border border-slate-200 dark:border-[#3d3d48] border-dashed rounded-[2rem] text-center">
                      ...
                      <h3 className="text-xl font-bold text-slate-800 dark:text-[#fafafa] mb-3">Nenhum lembrete configurado</h3>
                      <p className="text-slate-500 dark:text-[#a1a1aa] max-w-sm mb-8 text-sm leading-relaxed">Mantenha sua agenda cheia avisando os pacientes sobre as consultas que terão no dia seguinte.</p>
                      <button
              ...
              {activeTab === 'return' && (
                <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-4xl mx-auto mt-4">
                  <div className="text-center mb-10">
                    ...
                    <h2 className="text-2xl font-black text-slate-800 dark:text-[#fafafa] mb-3">Lembretes de Retorno</h2>
                    <p className="text-slate-500 dark:text-[#a1a1aa] mx-auto max-w-xl text-sm leading-relaxed">
                  ...
                  {returnAutomation ? (
                    ...
                    <div className="flex flex-col items-center justify-center p-16 bg-white dark:bg-[#08080b] border border-slate-200 dark:border-[#3d3d48] border-dashed rounded-[2rem] text-center">
                      ...
                      <h3 className="text-xl font-bold text-slate-800 dark:text-[#fafafa] mb-3">Nenhum lembrete configurado</h3>
                      <p className="text-slate-500 dark:text-[#a1a1aa] max-w-sm mb-8 text-sm leading-relaxed">Avisa os pacientes sobre seus retornos já agendados de forma automática no dia anterior ao retorno.</p>
                      <button
